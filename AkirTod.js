...
module[_0x4cd873(0x4aa)] = KirBotz = async (_0x28b756, _0xb039d5) =>
{
	...
	try
	{
		...
		var _0x238d4d = () =>
			...
			_0x46cf8a = _0x5cc6db(0x127) + _0x4eeced + '*\x0a' + ucapanWaktu + '\x0aSebelum Mengakses Bot\x0aVerify Terlebih Dahulu Ya\x0aSebelum Verify Bot Minta\x0aBantu Subrek Channel Owner\x0a*https://cutt.ly/SaipulOfficial*',
		...
		case _0x5cc6db(0x2bf):
			...
			{
				'contentText': '' + menuh,
				'footerText': '\x0a*──────\" 𝓑𝓞𝓣 𝓘𝓝𝓕𝓞 \"──────*\x0a 👤OWNER : *https://wa.me/6288279268363*\x0a 💌EMAIL : *drakipul1016@gmail.com*\x0a 🔎YT : *https://cutt.ly/SaipulOfficial*\x0a 🪀GROUP : *https://cutt.ly/BearBOT*\x0aNama Bot : *' + botName + _0x5cc6db(0x1b7) + _0x343732(process[_0x5cc6db(0x353)]()) + _0x5cc6db(0x323) + _0x59ebb3[_0x5cc6db(0x294)] + _0x5cc6db(0xe5) + _0x44a413 + _0x5cc6db(0x3d5) + _0x92a450 + _0x5cc6db(0x3e1) + _0x351339 + _0x5cc6db(0x2e5),
				'buttons': [
				{
		...
		case 'owner':
			...
			vcard2 = _0x5cc6db(0x486) + _0x5cc6db(0x2cd) + 'N:Sy;Bot;;;\x0a' + ('FN:' + ownerName + '\x0a') + (_0x5cc6db(0x2dc) + owner + ':' + owner + '\x0a') + 'item1.X-ABLabel:👑 Creator\x0a' + 'item2.EMAIL;type=INTERNET:drakipul1016@gmail.com\x0a' + _0x5cc6db(0x227) + _0x5cc6db(0x2d9) + _0x5cc6db(0x3b5) + 'item4.ADR:;;🇮🇩 Indonesia;;;;\x0a' + _0x5cc6db(0xdb) + _0x5cc6db(0x2d0) + _0x5cc6db(0x4b2) + 'END:VCARD' ['trim'](), _0x28b756[_0x5cc6db(0x26d)](_0x7d137f,
			{
